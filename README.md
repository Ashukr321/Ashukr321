...
| **TicketBuddy.ai** <br> 👨‍💻 MERN Intern <br> 🗓️ *United Kingdom* | **AI Mailing Platform** | • Integrated **AI APIs** for automated mail generation and tracking systems. <br> • Built secure, high-performance forms with **React Hook Form & Zod**. <br> 🛠️ *MongoDB, Express, React, Node.js* | [🏢 Company](https://ticketbuddy.ai/) |
---
